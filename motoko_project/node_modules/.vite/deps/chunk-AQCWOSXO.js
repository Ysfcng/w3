...
var cbor, NANOSECONDS_PER_MILLISECONDS, REPLICA_PERMITTED_DRIFT_MILLISECONDS, Expiry;
var init_transforms = __esm({
  "node_modules/@dfinity/agent/lib/esm/agent/http/transforms.js"() {
    init_esm2();
    cbor = __toESM(require_src());
    init_types();
...
var __classPrivateFieldGet3, _Observable_instances, _Observable_call, _ObservableLog_instances, _ObservableLog_call, Observable, ObservableLog;
var init_observable = __esm({
  "node_modules/@dfinity/agent/lib/esm/observable.js"() {
    ...
    Observable = class extends Function {
      constructor() {
        super();
...
var __classPrivateFieldSet4, __classPrivateFieldGet5, _HttpAgent_instances, _HttpAgent_retryTimes, _HttpAgent_backoffStrategy, _HttpAgent_waterMark, _HttpAgent_queryPipeline, _HttpAgent_updatePipeline, _HttpAgent_subnetKeys, _HttpAgent_verifyQuerySignatures, _HttpAgent_requestAndRetryQuery, _HttpAgent_requestAndRetry, _HttpAgent_verifyQueryResponse, RequestStatusResponseStatus, DEFAULT_INGRESS_EXPIRY_DELTA_IN_MSECS, IC_ROOT_KEY, MANAGEMENT_CANISTER_ID, IC0_DOMAIN, IC0_SUB_DOMAIN, ICP0_DOMAIN, ICP0_SUB_DOMAIN, ICP_API_DOMAIN, ICP_API_SUB_DOMAIN, HttpDefaultFetchError, IdentityInvalidError, HttpAgent;
var init_http = __esm({
  "node_modules/@dfinity/agent/lib/esm/agent/http/index.js"() {
    init_esm();
    init_errors();
...
`);
      ...
      async syncTime(canisterId) {
        const CanisterStatus = await import("./canisterStatus-PQMMN7QT.js");
...
var ProxyMessageKind, ProxyStubAgent, ProxyAgent;
...
var init_management_idl = __esm({
  "node_modules/@dfinity/agent/lib/esm/canisters/management_idl.js"() {
    management_idl_default = ({ IDL }) => {
...
var import_buffer6, ActorCallError, QueryCallRejectedError, UpdateCallRejectedError, metadataSymbol, Actor, DEFAULT_ACTOR_CONFIG, ACTOR_METHOD_WITH_HTTP_DETAILS;
var init_actor = __esm({
  "node_modules/@dfinity/agent/lib/esm/actor.js"() {
    ...
    init_buffer();
    init_management_idl();
    ActorCallError = class extends AgentError {
    ...
    QueryCallRejectedError = class extends ActorCallError {
    ...
    UpdateCallRejectedError = class extends ActorCallError {
...
var init_asset_idl = __esm({
  "node_modules/@dfinity/agent/lib/esm/canisters/asset_idl.js"() {
    asset_idl_default = ({ IDL }) => {
      return IDL.Service({
...
@noble/curves/esm/ed25519.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-AQCWOSXO.js.map
