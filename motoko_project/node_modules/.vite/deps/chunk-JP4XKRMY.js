...
var import_borc, cbor, import_simple_cbor, PrincipalEncoder, BufferEncoder, BigIntEncoder, serializer, CborTag, Uint8ArrayDecoder;
var init_cbor = __esm({
  "node_modules/@dfinity/agent/lib/esm/cbor.js"() {
    ...
    Uint8ArrayDecoder = class extends import_borc.default.Decoder {
...
var InputBox, InputForm, RecordForm, TupleForm, VariantForm, OptionForm, VecForm;
var init_candid_core = __esm({
  "node_modules/@dfinity/candid/lib/esm/candid-core.js"() {
    InputBox = class {
      ...
      parse(config = {}) {
        if (this.ui.form) {
          const value2 = this.ui.form.parse(config);
          this.value = value2;
          return value2;
        }
        if (this.ui.input) {
          ...
          try {
            const value2 = this.ui.parse(this.idl, config, input.value);
            if (!this.idl.covariant(value2)) {
    ...
    RecordForm = class extends InputForm {
      ...
      parse(config) {
        ...
        this.fields.forEach(([key, _], i) => {
          const value2 = this.form[i].parse(config);
          v[key] = value2;
        });
    ...
    TupleForm = class extends InputForm {
    ...
    VariantForm = class extends InputForm {
      constructor(fields, ui) {
        super(ui);
        this.fields = fields;
        this.ui = ui;
      ...
      parse(config) {
        ...
        const value2 = this.form[0].parse(config);
        if (value2 === void 0) {
          return void 0;
        }
        const v = {};
    ...
    OptionForm = class extends InputForm {
      constructor(ty, ui) {
        super(ui);
        this.ty = ty;
        this.ui = ui;
    ...
    VecForm = class extends InputForm {
      constructor(ty, ui) {
        super(ui);
        this.ty = ty;
        this.ui = ui;
      ...
      parse(config) {
        const value2 = this.form.map((input) => {
...
function renderValue(t, input, value2) {
  return t.accept(new RenderValue(), { input, value: value2 });
}
var InputConfig, FormConfig, inputBox, recordForm, tupleForm, variantForm, optForm, vecForm, Render, Parse, Random, RenderValue;
var init_candid_ui = __esm({
  "node_modules/@dfinity/candid/lib/esm/candid-ui.js"() {
    init_idl();
    init_esm();
    init_candid_core();
    InputConfig = { parse: parsePrimitive };
    FormConfig = { render: renderInput };
    inputBox = (t, config) => {
      return new InputBox(t, Object.assign(Object.assign({}, InputConfig), config));
    };
    recordForm = (fields, config) => {
      return new RecordForm(fields, Object.assign(Object.assign({}, FormConfig), config));
    };
    tupleForm = (components, config) => {
      return new TupleForm(components, Object.assign(Object.assign({}, FormConfig), config));
    };
    variantForm = (fields, config) => {
    ...
    RenderValue = class extends Visitor {
      visitType(t, d) {
...
__export(esm_exports2, {
  ...
  VecForm: () => VecForm,
  bufFromBufLike: () => bufFromBufLike2,
  concat: () => concat2,
...
var _0n5, _1n5, _2n5, _3n4, _4n3, _8n2, _16n2, Fp_raw, Fp, Fr, Fp2Add, Fp2Subtract, Fp2Multiply, Fp2Square, FP2_ORDER, Fp2, FP2_FROBENIUS_COEFFICIENTS, rv1, FP2_ROOTS_OF_UNITY, Fp6Add, Fp6Subtract, Fp6Multiply, Fp6Square, Fp6, FP6_FROBENIUS_COEFFICIENTS_1, FP6_FROBENIUS_COEFFICIENTS_2, BLS_X, BLS_X_LEN, Fp12Add, Fp12Subtract, Fp12Multiply, Fp12Square, Fp12, FP12_FROBENIUS_COEFFICIENTS, isogenyMapG2, isogenyMapG1, G2_SWU, G1_SWU, ut_root, wsq, wcu, wsq_inv, wcu_inv, PSI2_C1, htfDefaults, COMPRESSED_ZERO, bls12_381;
var init_bls12_381 = __esm({
  "node_modules/@noble/curves/esm/bls12-381.js"() {
    ...
    _8n2 = BigInt(8);
    _16n2 = BigInt(16);
    Fp_raw = BigInt("0x1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab");
    Fp = Field(Fp_raw);
    ...
    rv1 = BigInt("0x6af0e0437ff400b6831e36d6bd17ffe48395dabc2d3435e77f76e17009241c5ee67992f72ec05f4c81084fbede3cc09");
    FP2_ROOTS_OF_UNITY = [
      [_1n5, _0n5],
      [rv1, -rv1],
      [_0n5, _1n5],
    ...
    PSI2_C1 = BigInt("0x1a0111ea397fe699ec02408663d4de85aa0d857d89759ad4897d29650fb85f9b409427eb4f49fffd8bfd00000000aaac");
    ...
    COMPRESSED_ZERO = setMask(Fp.toBytes(_0n5), { infinity: true, compressed: true });
    bls12_381 = bls({
      // Fields
      fields: {
        Fp,
...
@noble/curves/esm/bls12-381.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-JP4XKRMY.js.map
